...
namespace CleanCode.NET
{
    ...
    [ProvideOptionPage(typeof(OptionPageGrid), "Clean Code .NET", "Settings", 0, 0, true)]
    ...
    public sealed class OptionsPackage : AsyncPackage
    {
        ...
        /// </summary>
        public const string PackageGuidString = "dd5eb2fb-9a3b-4172-952e-37e572b30c55";
        ...
        {
            var options = (OptionPageGrid)GetDialogPage(typeof(OptionPageGrid));
            options.ApplyToSettings(Settings.Current);
        }
